	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
         ...
         <ul class="list-group dropdown-menu">
                                            <li class="list-group-item"><a href="#"><i class="fa fa-user fa-fw"></i>个人中心</a></li>
                                            <li class="list-group-item"><a href="${pageContext.request.contextPath}/logout"><i class="fa fa-sign-out fa-fw"></i>安全退出</a></li>
